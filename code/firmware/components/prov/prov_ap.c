...
".warn{margin:.9rem 0 0;padding:.7rem .8rem;border:2px solid #b91c1c;border-radius:.35rem;"
"background:#dc262615;color:#b91c1c}"
"</style></head><body>"
"<h1>e-ink weather display</h1>"
"<p class=\"sub\">Enter your network and weather details. They are stored only on the "
"device.</p>"
"<p class=\"warn\"><b>WARNING: this display can only join a 2.4&nbsp;GHz network.</b> "
"If the name below is a 5&nbsp;GHz network it will not connect, even with the correct "
"password.</p>"
"<form id=\"f\">"
